...
public class WorkoutController {
    ...
    @DeleteMapping("workout/{workoutID}/exercise/{id}")
    public void deleteExerciseFromWorkout(@Valid @PathVariable Long id, @Valid @PathVariable Long workoutID){
        this.workoutExerciseDao.deleteExerciseFromWorkout(id, workoutID);
    }
